...
import { createJSMap, createJSSet, createJSWeakMap } from "../../../src/objects/heap/factory.js";
...
describe("MAP_METHODS", () => {
  ...
  it("throws on non-Map receiver", () => {
    const fakeObj = mkObject(getPayload(mkObject(require("../../../src/objects/heap/factory.js").createJSObject())));
...
describe("WEAKMAP_METHODS", () => {
  it("set/get/has/delete lifecycle with object keys", () => {
    ...
    const key = mkObject(require("../../../src/objects/heap/factory.js").createJSObject());
  ...
  it("different object keys are independent", () => {
    const wm = makeWeakMap();
    const { createJSObject } = require("../../../src/objects/heap/factory.js");
